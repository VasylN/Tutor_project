...
2.5. нит 5 должна читать с консоли цифры пока не введено слово "N", а потом вывести в консоль сумму введенных цифр.
    ...
    public void run() {
        ...
        try {
            while (!isInterrupted()) {
                ...
                if (i.equals("N")) this.interrupt();
                else sum += Integer.parseInt(i);
            }
